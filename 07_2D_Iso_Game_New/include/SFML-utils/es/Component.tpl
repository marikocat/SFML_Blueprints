#include <SFML-utils/es/EntityManager.h>
#include <cassert>
...
namespace sfutils
{
	namespace es
	{
		...
		template<typename COMPONENT, typename ENTITY>
		ComponentHandle<COMPONENT, ENTITY>::ComponentHandle(const EntityManager<ENTITY>* manager, std::uint32_t entity_id)
			: _manager(manager), _entityId(entity_id)
		{
		...
		template<typename COMPONENT, typename ENTITY>
		void Component<COMPONENT, ENTITY>::remove()
		{
