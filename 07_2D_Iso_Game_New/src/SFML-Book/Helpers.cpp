...
namespace book
{
	void makeAsMain(Entity& entity, Team* team, Level& level)
	{
		...
		entity.onHitted = [](Entity& self, const sf::Vector2i& myCoord, Entity& enemy, const sf::Vector2i& enemyCoord, Level& lvl)
		{
	...
	void makeAsEye(Entity& entity, Team* team, Level& level)
	{
		...
		entity.onHit = [](Entity& self, const sf::Vector2i& myCoord, Entity& enemy, const sf::Vector2i& enemyCoord, Level& lvl)
		{
