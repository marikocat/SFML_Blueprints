...
namespace book
{
	TeamGui::TeamGui(Team& team, sf::RenderWindow& window, const sf::Color& color) :
		...
		_status(Status::None)
	{
		Configuration::setGuiColor(sf::Color(color.r * 0.4, color.g * 0.4, color.b * 0.4, 240));
