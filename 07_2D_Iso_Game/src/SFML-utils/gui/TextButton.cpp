#include "SFML-utils/gui/TextButton.h"
...
namespace sfutils
{
    namespace gui
    {
        ...
        {
            setFillColor(sfutils::gui::Configuration::Colors::button_fill);
            setOutlineThickness(sfutils::gui::Configuration::Sizes::button_outline_thickness);
            setOutlineColor(sfutils::gui::Configuration::Colors::button_outline);
        }
