...
namespace book
{
    ...
    void makeAsMain(Entity& entity, Team::pointer team, Game& game)
    {
    ...
    void makeAsEye(Entity& entity, Team::pointer team, Game& game)
    {
    ...
    void makeAsWormEgg(Entity& entity, Team::pointer team, Game& game)
    {
    ...
    void makeAsWorm(Entity& entity, Team::pointer team, Game& game)
    {
    ...
    void makeAsCarnivor(Entity& entity, Team::pointer team, Game& game)
    {
