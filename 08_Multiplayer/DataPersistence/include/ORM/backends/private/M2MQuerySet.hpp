...
namespace orm
{
    ...
    class M2MQuerySet
    {
        public:
             ...
             **/
            int get(typename LINKED::pointer_array & objs, int max_depth = ORM_DEFAULT_MAX_DEPTH);
             ...
             * \return Number of objects
             **/
            // int get(typename OWNER::pointer_array& objs, int max_depth = ORM_DEFAULT_MAX_DEPTH);
